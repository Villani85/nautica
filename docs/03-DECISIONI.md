...
| ~~A07~~ | revisione 08 §2 | ~~La direzione artistica non esiste~~ | **CHIUSA** da `docs/09-DIREZIONE-ARTISTICA.md`: l'immagine di riferimento ha definito accento, spessore di sezione e i due registri di resa. Restano fuori tipografia (P01-bis) e impaginazione |
| A08 | 09 §Le persone | **Le persone: stilizzate, fotografiche come piano, o assenti?** | l'allestimento sopra la linea, cioe' la meta' emotiva della tesi | non sono generabili a 3.000 facce senza texture: una figura umana e' precisamente cio' che quel budget non regge, e non passerebbe il collaudo in scala di grigi |
