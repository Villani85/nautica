...
| D53 | 2026-08-26 | **Con una famiglia sola, la gerarchia la fa il peso**: corpo 350, titolo 400, sottotitolo 600, enfasi 800 | con due famiglie il contrasto veniva dal disegno — grottesca contro monospaziata. Con Recursive quel contrasto non c'e' piu', e tenendo tutto a 300 titoli e corpo si appiattivano. Visto nel provino della sequenza, non previsto |
| D54 | 2026-08-26 | **Dal picco alla RMS, e poi alla tabella precalcolata** | il rapporto fra i due PICCHI non converge: la forzante e' somma di tre armoniche a 0,51w, 0,83w e 1,37w — periodi incommensurabili, che non tornano mai in fase — quindi il massimo su una finestra finita dipende da dove capiti dentro il battimento. Misurato: 5,60 punti di escursione fra caricamenti col picco, **0,19 con la RMS**. E due secondi dopo l'accensione il sito dichiarava 52% invece di 90, perche' ogni gesto azzerava le finestre e l'inviluppo ha costante di tempo 24,8 s. Adesso il numero e' il rapporto delle RMS a regime, calcolato una volta da `strumenti/genera-riduzioni.mjs` e versionato in `riduzioni.json` |
| D55 | 2026-08-26 | **L'onda si spegne attorno all'obiettivo** | la camera sta a quota zero e la superficie oscilla ATTORNO a quella quota: a mare 5 le creste salgono a +0,30 e la sommergevano. La meta' chiara del fotogramma diventava (28,29,29) invece di (233,229,221) — spariva la linea, cioe' l'unica idea meccanica del sito. Non si alza la camera e non si abbassa il mare: si spegne l'onda in un raggio di 5,5 unita', con la superficie tenuta 0,10 sotto. Cancello: `collaudo-mare.mjs` |
| D56 | 2026-08-26 | **L'invariante e' il BECCHEGGIO zero, non la quota zero** — e vale con la sua meta' scomoda | in dodici punti fra `docs/` e `src/` era scritto che la linea sta a meta' schermo *perche' la camera sta a quota zero*. E' il `lookAt` alla stessa quota a produrla, e la parola «beccheggio» non compariva da nessuna parte nel repository. Misurato: a quota 1,28 con sguardo orizzontale l'orizzonte proietta a **0,019 px** dal centro su una tela alta 900 — la geometria sopravvive a qualunque quota. **Ma la lettura tonale no**: alzandosi si guarda dall'alto una superficie illuminata, la meta' bassa smette di essere acqua profonda e lo spacco muore lo stesso, per una ragione diversa. Senza la seconda meta', questa correzione autorizzerebbe proprio l'errore che l'ha prodotta |
| D57 | 2026-08-26 | **Il nome sta sulla nave, non su un'azienda che non esiste** | chiude A01. Uno yacht autoprodotto e dichiarato tale (gia' deciso in `09` §6), con lo studio che firma il lavoro. Un costruttore inventato sarebbe una **credenziale finta**, ed e' la prima cosa che un giurato controlla: un sito la cui tesi e' l'onesta' tecnica non puo' mentire sulla prima schermata. E non e' un ripiego — sei su trenta vincitori del Sito dell'Anno sono progetti in cui autore e committente coincidono |
| D58 | 2026-08-26 | **Nessun cancello misura millisecondi** | `collaudo-rollio` chiedeva che un calcolo stesse in 16 ms ed era **rosso su main**: otto esecuzioni fra 16,9 e 19,1, e piu' tardi 51,7. Lo stesso identico codice — cambiava solo quanto era carica la macchina. Un tetto in millisecondi misura il computer, non il codice, e alzarlo non lo aggiusta. I cancelli misurano **lavoro** (numero di passi, valori attesi) o **confrontano con un file versionato** |
| D59 | 2026-08-26 | **Didascalia e letture nello stesso flusso** | erano due blocchi assoluti che crescevano l'uno verso l'altro, e in `stile.css` non esisteva **nessuna media query sull'altezza**: a 1280x720 la finestra e' larga ma bassa e niente compensava. `collaudo-impaginato.mjs` ha contato **34 sovrapposizioni** dove a occhio ne avevo vista una — 113 px a 1280x720, e sul telefono le letture sopra i comandi. Dentro un `flex` non possono toccarsi perche' lo garantisce il layout, non una soglia indovinata |
| D60 | 2026-08-29 | **L'IA generativa e' ammessa, e non e' Awwwards a vietarla.** Nelle condizioni ufficiali non compare nessun divieto su intelligenza artificiale, generatori 3D o strumenti di terzi: sono vietati i contenuti illegali, ed e' prevista una revisione in caso di sospetto plagio. Il giudizio resta su Design, Creativity, Usability, Content | Correzione di un errore commesso in questa sessione: avevo citato **D05** («zero modelli di terzi») come se fosse una regola di Awwwards, e per giunta D05 era gia' stato superato da **D19** il 25 agosto. Due errori in una frase. E la conferma non e' teorica: Awwwards ha gia' dato Honorable Mention a progetti che dichiarano immagini, voce o ambienti generati con IA — *A(i)strology*, *OUBEY MINDSPACE* — e vende un corso sui visual generativi |
| D61 | 2026-08-29 | **Dove l'IA generativa puo' entrare, e dove no.** SI': figure umane secondarie, base dei mobili, elementi ambientali non protagonisti. NO, non senza pesante lavorazione: yacht principale, stabilizzatore, propulsione, giroscopio, e qualunque oggetto in primissimo piano | Non e' una regola di ammissibilita', e' una regola di VOTO. Un asset generativo che conserva anatomia generica, materiali uniformi, topologia incoerente non viene penalizzato perche' e' IA: viene penalizzato perche' **sembra un asset mediocre**, e il colpo arriva su Design e Creativity. I pezzi protagonisti passano da Blender: retopologia, proporzioni, UV, materiali, contatti, ombre, animazione. **Lo strumento puo' produrre la materia grezza; l'autorialita' sta nella trasformazione e nel comportamento** |
| D62 | 2026-08-29 | **La regola dei video generati, in una riga: l'IA puo' generare la REAZIONE delle persone, ma non puo' possedere la CONTINUITA' dello spazio** | Il pericolo dei filmati generativi qui non e' regolamentare, e' artistico: persone che cambiano volto o vestito, bicchieri che si trasformano, luce che salta, un'inquadratura che sembra di un altro film. Sono tutti modi di rompere la scena unica, che e' la conquista piu' costosa di questo repo. Quindi il filmato resta una **tessitura integrata**, registrata sulla stessa camera, mentre mare, rollio, meccanismo e navigazione restano comandati dal sito. E' gia' cosi' per `traversata.mp4`, e adesso e' una regola invece di un'attuazione |
| D63 | 2026-08-29 | **Tripo solo con account a pagamento per gli asset definitivi, e con la provenienza conservata**: ricevuta, data di generazione, prompt, immagini sorgenti, file originale, copia delle condizioni vigenti quel giorno | Le condizioni riconoscono ai paganti diritti ampi su input e output; per gli utenti gratuiti Tripo dichiara di **trattenere** i diritti sugli asset generati, ed e' una formulazione troppo sfavorevole per un progetto candidato. Inoltre Tripo non garantisce che l'output sia esclusivo: la responsabilita' sugli input resta di chi genera. Quindi yacht generico senza marchio si', meccanismo inventato si', **copia di uno stabilizzatore brevettato o di uno yacht identificabile no** |
| D64 | 2026-08-29 | **Il colophon dichiara la pipeline**, anche se Awwwards non lo impone | Non e' un obbligo: e' l'unico modo per togliere in anticipo il sospetto di attribuzione falsa. E il sospetto costa piu' della dichiarazione. Il testo sta in `index.html`, nel contatto |
| D65 | 2026-08-29 | **Il finale torna alle STESSE persone dell'apertura, e il punto di giunzione lo sceglie una misura.** La traversata tiene fino allo scalone -- pinna sott'acqua, sala macchine, scala -- e da li' passa alla coda di un secondo filmato che percorre lo stesso tragitto e arriva sulla coppia dell'apertura. Giunzione a traversata 5,40s / coda 5,80s, dissolvenza 0,5 s | Il finale precedente arrivava in **un'altra barca**: salone chiaro, quattro o cinque figure, nessuna delle due persone dell'apertura. Il payoff che il codice prometteva era oggettivamente falso. Misurato stanza contro stanza col finestrone escluso (a fotogramma intero si confrontano le inquadrature, non la grana): apertura calore R-B **49,8**, finale vecchio **2,3** -- non un altro salone, una stanza **acromatica**. Il punto di giunzione non e' stato scelto a occhio: il minimo di scarto fra i due percorsi cade dove tutti e due sono in cima allo scalone. La gradazione pure: gamma 0,80 porta lo scarto da 47,5 a **0,7** di calore e 4,2 di luminanza. Coerente con **D62**: l'IA porta la reazione delle persone, il sito comanda mare, rollio e meccanismo |
| D66 | 2026-08-29 | **Un suggerimento puo' dipendere dallo STATO CAUSALE invece che dall'inattivita'**, e quello del giroscopio lo fa: propulsione spenta, pinne accese, andatura sotto l'ipotesi. Chi ha `quando` e' esente dalla pausa di 5,2 s; gli altri la rispettano | In un sito guidato dallo scorrimento un nudge legato all'inattivita' e' strutturalmente troppo timido: ogni rotella azzera il timer, e l'atto due esisteva nel codice senza essere vissuto. Fra i cinque testi **nessuno nominava il giroscopio**, che e' la scoperta conclusiva. La condizione e' la contraddizione che il giroscopio scioglie: la nave rolla di nuovo **con gli stabilizzatori inseriti**. Misurato in tutte e due le direzioni -- a 12,00 kn nessuna bolla, a 6,95 kn compare -- perche' una bolla che comparisse comunque sarebbe a tempo con una condizione decorativa |
| D67 | 2026-08-29 | **Il workflow e' un artefatto e ha un cancello, che gira in LOCALE** (`collaudo-workflow.mjs`) | Due `env:` nello stesso passo di `pubblica.yml` hanno tenuto il sito non pubblicato per sette corse: chiave duplicata, Actions rifiuta il file intero, zero job, nessun errore che dica dove. **PyYAML quel file lo carica senza lamentarsi** e riporta 24 passi -- validarlo con quello avrebbe confermato l'errore. Diciotto cancelli sul sito e nessuno leggeva il file che decide se girano. Sta in locale e non in CI perche' un cancello dentro la CI non puo' vedere una CI che non parte |
| D68 | 2026-09-02 | **Il guscio del salone porta la fotografia PROIETTATA dal punto in cui e' stata scattata, e nella traversata la miscela sale con la corsa** (`src/scena/proiezione.js`, `?proiezione=`, `?proiezioneda=`) | Gli ultimi otto secondi della traversata erano una scatola color crema: il guscio non portava nessuna immagine. Qui la proiezione si puo' fare perche' la traversata FINISCE sulla camera sorgente -- l'origine del frame del mondo E' `CAMERA_SORGENTE_SALONE`, l'ultima posa e' [0,0,0], e `riferimenti/salone/posa.json` dichiara la lente a 34 gradi. Quindi l'errore della proiezione si CHIUDE mentre ci si avvicina, ed e' nullo dove la lastra prende il comando. Misurato con la griglia 32x32: **198 livelli su 255** di scarto fra proiezione accesa e spenta alla fine della corsa, contro un fondo di rumore di 6. La miscela comincia a 0,42, cercato guardando fra due difetti opposti (a 0,55 in cima alla scala c'e' un rettangolo bianco; a 0,30 la fotografia si spalma sulle pareti viste di scorcio) e si spegne sulla stessa rampa con cui la lastra si riempie (0,125), cosi' le due immagini si scambiano invece di sommarsi. **E il guscio non aveva le UV che il codice dichiarava**: `guscio-salone.glb` ha `POSITION` e `NORMAL` e basta, quindi `?guscio=1` dipingeva tutto il guscio col colore di un texel -- non era da tarare, era rotto |
| D69 | 2026-09-02 | **Sotto coperta l'ambiente non e' zero: e' una mappa della STANZA** (`creaAmbienteInterno`, `?riflesso=`) | `isolaDallaLuceDiFuori` metteva `envMapIntensity = 0` con una ragione giusta -- il mare entrava da tutte le paratie -- ma zero e' l'altro estremo: i tubi e il corrimano hanno `metalness` alto e leggevano come plastica, e le normali procedurali di `materie-mondo.js` erano moltiplicate per il nulla. Una tela 128x64 (cielino caldo, paratie a meta' tono, pagliolo scuro) prefiltrata col PMREM costa zero byte di rete. Misurato: 28-32 livelli di scarto contro un rumore di 6 |
| D70 | 2026-09-02 | **La luce delle stanze della traversata e' COTTA** (`cuoci-luce-mondo.py`, `lightMap`), e a runtime restano tre lampade per il solo arredo, su uno strato suo | In three il NUMERO di luci entra nella chiave del programma di ogni materiale: dieci lampade accese costano 75 ms di fotogramma ciascuna su GPU software, e ogni volta che il numero cambia tutta la scena si ricompila. E' la radice misurata di tre blocchi: 5,3 s alla giunzione fra traversata e salone, 1,3 a un terzo della coda, 8,3 all'avvio -- e delle corse 307, 308 e 309, morte su cancelli che aspettano un fotogramma. Le stanze non si muovono e le lampade nemmeno, quindi la loro luce e' un DATO come l'occlusione: cotta in Cycles con lampade AD AREA nelle posizioni che il sito stesso misura ed esporta, DIFFUSE diretto+indiretto (col rimbalzo, che il tempo reale non ha). Su Colab con la T4: 2048 campioni, 112 s per i tre atlanti. Dopo: giunzione 1.272 ms, fotogramma su GPU software 1.039 (era 1.429), fluidita' 60 fps. `?lucecotta=0` torna alle lampade vive |
| D51 | 2026-08-26 | **Il titolo va a capo dove decidiamo noi**: *what you buy* sopra la linea, *is underneath* sotto | in inglese la frase non stava su una riga sola. Invece di rimpicciolirla, l'interruzione e' diventata deliberata: la frase si divide dove si divide il senso, e la parola «underneath» finisce letteralmente sotto. I tratti discendenti restano tagliati a meta' glifo |
| D52 | 2026-08-26 | **La battuta dell'interruttore non blocca la sequenza** | se non lo si accende il racconto prosegue e mostra una nave che continua a rollare, con un avviso. Un sito che si ferma finche' non clicchi chiede obbedienza; questo mostra cosa succede se non fai niente, che e' la tesi. Coerente con D27 |
| D45 | 2026-08-25 | **La riduzione del rollio si MISURA**: due simulazioni in parallelo, identiche tranne che una ha autorita' zero. Il numero a schermo e' `1 - picco_stab/picco_nuda` | prima era `SMORZAMENTO = 0.11` scritto a mano e il sito mostrava 89% senza averlo mai calcolato. Costa quindici righe eseguite due volte e rende il dato onesto per costruzione |
| D46 | 2026-08-25 | **L'autorita' delle pinne va col quadrato della velocita'**, e oltre i 20 gradi la portanza CALA invece di essere tagliata | chiude A06. A nave ferma la riduzione vale zero, come nella realta'. E lo stallo e' cio' che rompe la linearita': con un semplice clamp la riduzione esce identica a ogni stato del mare |
| D47 | 2026-08-25 | **A velocita' di servizio la riduzione E' quasi costante, ed e' giusto cosi'** | misurato: a 12 nodi la pinna arriva a 10,9 gradi e non satura, quindi il sistema lavora nel tratto lineare. La variabilita' vive a bassa andatura, dove le pinne sono al limite: a 8 nodi va da 79,5% al mare 1 a 16,8% al mare 5 |
| D48 | 2026-08-25 | **"Varia?" e' una domanda statistica**: si confronta la varianza fra condizioni con quella fra corse nella stessa condizione, non con una soglia fissa | due stesure del collaudo fallivano una volta su tre. Un cancello che suona a intermittenza e' peggio di nessun cancello |
| D49 | 2026-08-25 | **Il finestrino e' un'apertura vera** e l'orizzonte sta in coordinate MONDO, dentro la tuga | chiude A08 sul lato del mare: la fotografia si vede attraverso un'apertura. E il rollio arriva gratis, perche' la stanza ruota e l'orizzonte no |
| D50 | 2026-08-25 | **Il verso delle normali e' un invariante collaudato** | l'avvolgimento del loft era rovesciato fin dall'inizio: 544 normali di murata su 544 puntavano dentro. Con `DoubleSide` non si vedeva. Il collaudo ora esce con errore se una sola punta dentro |
| D43 | 2026-08-25 | **Un file solo, con `MONO` e peso entrambi variabili** — non due istanze | misurato su 108 glifi: 40,2 KB contro 62,0 delle due istanze, e una sola richiesta di rete. Due file istanziati duplicano le curve, uno variabile le condivide. **E si sottoinsiema PRIMA di istanziare**, o `gvar` resta incoerente e fontTools muore su `space` |
| D44 | 2026-08-25 | **Divieto: mai `pnum`. Assi inchiodati: `CRSV`=0, `slnt`=0, `CASL`=0** | «cifre tabulari per costruzione» era troppo forte: `pnum` porta l'1 da 600 a 400, e l'1 e' la cifra piu' frequente in una lettura che cambia 60 volte al secondo. E `CRSV` ha default 0,5, cioe' corsivo automatico |
...
| ~~A02~~ | **CHIUSA**: il sito e' in inglese. Applicato a `index.html`, `src/regia.js` e alle etichette assistive. I commenti del codice restano in italiano: sono per chi lo scrive |
| ~~A02-vecchia~~ | brief §7.2 | **La lingua** | tutto il copy, e la leggibilità della sezione 3 da parte della giuria | inglese; italiano con etichette tecniche in inglese; italiano puro |
...
| ~~A04~~ | **CHIUSA**: adottata **Recursive** (OFL-1.1). Un file, 39,7 KB, `MONO` e peso variabili. Percorso critico da 75,8 a **48,5 KB gzip**, −36% |
| ~~A04-vecchia~~ | P01-bis | **Quali due famiglie tipografiche** | il CSS, ma **non** il porto a Vite né i difetti | da decidere **dopo** il censimento delle `font-family` degli ultimi 20 SOTD |
