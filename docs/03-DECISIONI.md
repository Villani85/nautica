...
| A07 | revisione 08 §2 | **La direzione artistica non esiste ancora** | tutto: il 70% del punteggio, e la coerenza di venti agenti | il documento gemello — tipografia, colore, impaginazione, riferimenti visivi — va scritto **prima** di costruire, non dopo. Il contratto dei sistemi protegge i materiali, non la composizione |
